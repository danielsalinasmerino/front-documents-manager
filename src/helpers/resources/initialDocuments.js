...
export const initialDocuments = [
    ...
    new Document(
        "7bNo3nIkKV2s2dKItB3JuKSadjSVIzCt",
        "Solicitud PDF",
    ...
    new Document(
        "7bNo2kIkKV2c2eKItB3JuKSvdjSVIeCt",
        "Politécnica Virtual",
    ...
    new Document(
        "8bNt2tIkKV2c2rKItB3JeKSvdjSVIdCt",
        "PDF",
    ...
    new Document(
        "6bNo2kIkKV3c4gKItB3JuLSvdjSVIeCt",
        ".Doc",
    ...
    new Document(
        "6bNo2kFkKV3c4gKItB9JuLSvdjSVIdCt",
        "PDF rellenable",
    ...
    new Document(
        "2bNo2kIkDD2c4gKItB3JuLSvdjSVIeFt",
        "Impreso de solicitud del MAP",
    ...
    new Document(
        "7bNe2kIkKV7c7gKItB3JuASvdjSVIeCt",
        "PDF rellenable",
    ...
    new Document(
        "7bNe2kIkKV7c9gKItB2JuASvgjSVIeCe",
        ".doc",
    ...
    new Document(
        "1dDe1kIkKV7c9gKItB2JuASvgjSVIeCe",
        "(.doc)",
    ...
    new Document(
        "2bNe2kIkKV7c2eKItD2DuASvgjSVIeCe",
        "(Enlace a Web UPM)",
    ...
    new Document(
        "2yNu4kIkKV4d2eKItD2DuASvgjSVIeCe",
        "(Enlace a Web UPM)",
